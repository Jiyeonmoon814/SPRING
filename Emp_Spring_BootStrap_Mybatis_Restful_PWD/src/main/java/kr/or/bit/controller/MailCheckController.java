...
public class MailCheckController {
	...
	@RequestMapping(value="/forgotPwd.member",method=RequestMethod.GET)
	public String forgotPwd() {
		return "join/ForgotPwd";
	}
	
	@RequestMapping(value="/forgotPwd.member",method=RequestMethod.GET)
	public String processForgotPassword(HttpServletRequest request, String mail, String code) {
		HttpSession session = request.getSession();
		String result = mailservice.emailCertification(session, mail, Integer.parseInt(code));
		return result;
	}
